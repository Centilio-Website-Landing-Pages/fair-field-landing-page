...
export default function CompletedProjectDetailPage() {
  ...
  const projectImages = [
    '/images/completed page -ff/Kotagiri Serene Villas – Kotagiri, Nilgiris (2018)/images/1.png',
    '/images/completed page -ff/Kotagiri Serene Villas – Kotagiri, Nilgiris (2018)/images/2.png',
    '/images/completed page -ff/Kotagiri Serene Villas – Kotagiri, Nilgiris (2018)/images/3.png',
    '/images/completed page -ff/Kotagiri Serene Villas – Kotagiri, Nilgiris (2018)/images/4.png'
  ];
    ...
    <main className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="absolute inset-0">
          <Image
            src="/images/current project page - ff/images/first fold image to all except homepage.jpg"
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          >
            ...
            >
              ...
              <span className="text-[#D3AC4A]"> Kotagiri, Nilgiris (2018)</span>
            </h2>
          </motion.div>
            ...
            >
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-6">
                  <div className="w-6 h-6 mt-2 flex-shrink-0">
                    <Image
                      src="/images/completed page -ff/Kotagiri Serene Villas – Kotagiri, Nilgiris (2018)/icons/same icons for 3 completed project page/Vector 1.svg"
                      alt="Location icon"
                      width={24}
                      height={24}
                    />
                ...
                <div className="flex items-start space-x-6">
                  <div className="w-6 h-6 mt-2 flex-shrink-0">
                    <Image
                      src="/images/completed page -ff/Kotagiri Serene Villas – Kotagiri, Nilgiris (2018)/icons/same icons for 3 completed project page/Vector 2.svg"
                  ...
                  <div>
                    <p className="text-[16px] font-medium text-[#37405E]" style={{ fontFamily: 'Futura-Medium' }}>
                      <span className="text-[18px]">Project Type: </span>Hill-View Premium Villas
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-6">
                  <div className="w-6 h-6 mt-2 flex-shrink-0">
                    <Image
                      src="/images/completed page -ff/Kotagiri Serene Villas – Kotagiri, Nilgiris (2018)/icons/same icons for 3 completed project page/Vector 3.svg"
                      alt="Units icon"
                      width={24}
                      height={24}
                    />
                  ...
                  <div>
                    <p className="text-[16px] font-medium text-[#37405E]" style={{ fontFamily: 'Futura-Medium' }}>
                      <span className="text-[18px]">Units: </span>9 Villas
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-6">
                  <div className="w-6 h-6 mt-2 flex-shrink-0">
                    <Image
                      src="/images/completed page -ff/Kotagiri Serene Villas – Kotagiri, Nilgiris (2018)/icons/same icons for 3 completed project page/Vector 4.svg"
                      alt="Calendar icon"
                      width={24}
                      height={24}
                    />
                  ...
                  <div>
                    <p className="text-[16px] font-medium text-[#37405E]" style={{ fontFamily: 'Futura-Medium' }}>
                      <span className="text-[18px]">Year of Completion: </span>2018
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-6">
                  <div className="w-6 h-6 mt-2 flex-shrink-0">
                    <Image
                      src="/images/completed page -ff/Kotagiri Serene Villas – Kotagiri, Nilgiris (2018)/icons/same icons for 3 completed project page/Vector 5.svg"
                      alt="Status icon"
                      width={24}
                      height={24}
                    />
                  ...
                  <div>
                    <p className="text-[16px] font-medium text-[#37405E]" style={{ fontFamily: 'Futura-Medium' }}>
                      <span>Status: </span><span>Sold Out</span>
                    </p>
                  </div>
                </div>
              </div>
